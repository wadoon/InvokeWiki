<?php /* Smarty version 2.6.19, created on 2008-05-13 19:35:03
         compiled from wiki_new.tpl */ ?>
<?php if ($_SESSION['loggedIn']): ?>
<h1>Neuer Artikel</h1>
<form id="new_article" method="post">
  <input type="hidden" name="action" value="new_article" />
  <b>Title:</b>
  <input type="text" name="title" id="title" size="80" value="<?php echo $_POST['title']; ?>
" />&nbsp;&nbsp;&nbsp;
  <b>Alias:</b>
  <input type="text" name="alias" id="alias" size="16" value="<?php echo $_POST['alias']; ?>
"/><br> 
  <b>Content</b><br>
  <textarea name="content" id="content" rows="25"
	    cols="80"><?php echo $_POST['content']; ?>
</textarea><br>	
...
$this->_smarty_include(array('smarty_include_tpl_file' => "nologin.tpl", 'smarty_include_vars' => array()));
